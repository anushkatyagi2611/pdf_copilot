...
document.getElementById("ask-btn").addEventListener("click", async () => {
  ...
  formData.append("page_num", (currentPage - 1).toString()); // ensure it's string
  ...
  chatBox.innerHTML += `<div class="chatbox-head"><strong class="bold1">You:</strong> ${question}</div>`;
  chatBox.innerHTML += `<div class="chatbox-data"><strong class="bold1">AI:</strong> ${data.answer}</div>`;
